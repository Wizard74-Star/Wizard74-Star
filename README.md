...
### Hey 👋🏻, I'm a Senior Full-Stack Blockchain Developer

<br/>

Seasoned senior full‑stack blockchain developer with 7 years of hands‑on experience architecting and deploying decentralized applications (dApps), smart contracts, and blockchain‑integrated solutions. I specialize in building secure, gas‑optimized smart contracts on Ethereum, Solana, and other leading blockchain networks, while crafting pixel‑perfect front‑ends with React/Next.js and TypeScript that seamlessly interact with Web3 protocols, while architecting resilient, event‑driven back‑ends in .NET 8, Node.js 20, Python (FastAPI/Django), and Java (Spring Boot). My expertise spans DeFi protocols, NFT marketplaces, tokenomics design, cross‑chain bridges, and blockchain infrastructure. I architect resilient, event‑driven back‑ends in .NET 8, Node.js 20, Python (FastAPI/Django), and Java (Spring Boot), integrating traditional web technologies with blockchain networks. A relentless advocate for security, performance, and decentralized architecture, I mentor cross‑disciplinary teams, conduct smart contract audits, and translate complex blockchain concepts into secure, scalable, and maintainable products that empower the decentralized web.
...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Building+the+Future+of+Web3;Smart+Contracts+%7C+DeFi+%7C+dApps;Blockchain+Architecture+%26+Security" alt="Typing SVG" />
</div>
...
<p>
  ...
  <img alt="Ethers.js" src="https://img.shields.io/badge/Ethers.js-3C3C3D?logo=ethereum&logoColor=white" />
  <img alt="Hardhat" src="https://img.shields.io/badge/Hardhat-FFF100?logo=hardhat&logoColor=black" />
  <img alt="Truffle" src="https://img.shields.io/badge/Truffle-3C3C3D?logo=truffle&logoColor=white" />
  <img alt="Foundry" src="https://img.shields.io/badge/Foundry-000000?logo=foundry&logoColor=white" />
  <img alt="Solana" src="https://img.shields.io/badge/Solana-9945FF?logo=solana&logoColor=white" />
  <img alt="Rust" src="https://img.shields.io/badge/Rust-000000?logo=rust&logoColor=white" />
  <img alt="Anchor" src="https://img.shields.io/badge/Anchor-5000B9?logo=anchor&logoColor=white" />
  <img alt="IPFS" src="https://img.shields.io/badge/IPFS-65C2CB?logo=ipfs&logoColor=white" />
  <img alt="The Graph" src="https://img.shields.io/badge/The_Graph-6C4FC7?logo=thegraph&logoColor=white" />
  <img alt="Chainlink" src="https://img.shields.io/badge/Chainlink-375BD2?logo=chainlink&logoColor=white" />
  <img alt="Polygon" src="https://img.shields.io/badge/Polygon-8247E5?logo=polygon&logoColor=white" />
  <img alt="Arbitrum" src="https://img.shields.io/badge/Arbitrum-28A0F0?logo=arbitrum&logoColor=white" />
  <img alt="Optimism" src="https://img.shields.io/badge/Optimism-FF0420?logo=optimism&logoColor=white" />
</p>
